                                ...
                                <div class="container-fluid">
                                  ...
                                  <div class="collapse navbar-collapse justify-content-center" >
                                    <div class="navbar-nav">
                                      <a class="nav-link  mx-1 active" aria-current="page" href="{{ url('blogs')}}">
                                        <i class="fa-solid fa-user me-1"></i>
                                        <span> Blogs</span>
                                      </a>
                                      <a class="nav-link  mx-1 active" aria-current="page" href="{{ url('my-profile')}}">
                                        <i class="fa-solid fa-user me-1"></i>
                                        <span> My Profile</span>
                                      </a>
                                      <a class="nav-link mx-1" href="{{ url('manage-profile')}}">
                                      ...
                                      <a class="nav-link mx-1" href="{{ url('/referrals-list')}}">
                                        <i class="fa-solid fa-tower-broadcast me-1"></i>
                                        <span>Referrals</span> 
                                      </a>
    
                                      <a class="nav-link mx-1" href="{{ url('/notice')}}">
