                    ...
                    <div class="col-7">
                        <div class="row justify-content-center">
                            <div class="col-10">
                                ...
                                <form action="{{ route('user_registered') }}" method="POST" enctype='multipart/form-data'> 
                                    @csrf

                                    <div class="mb-3">
                                        <label for="referral_code" class="form-label">Referral Code (optional)</label>
                                        <input type="text" class="form-control pe-none  bg-tertiary"
                                            id="referral_code" name="referral_code" value="{{ $refer_code }}">
