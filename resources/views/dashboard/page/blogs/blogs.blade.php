                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{url('admin/add-blogs')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        @endif
                                            <div class="d-flex justify-content-between w-100">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="dropdown">
                                                        <a class="btn" style=" border:none; color:#000000" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                            <span><i class="fa-solid fa-ellipsis-vertical"></i></span>
                                                        </a>
                                                       
                                                        <form class="dropdown-menu" action="{{ route('admin_delete_blog',$data->blog_id) }}" method="POST">
