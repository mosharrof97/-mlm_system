                                    ...
                                    <div class="author-items" style="border: 1px solid white">
                                            ...
                                            <div class="item">
                                                <div class="info" style="width: 100%; padding-top: 20px">
                                                    <h5 class=" text-black "> <a class="notice-title text-black "  href=" {{ url('admin/single_notice',$notice->notice_id) }}" > {{$notice->notice_name}}</a>
                                                    </h5>
                                                    <ul class="d-flex align-items-center justify-content-between mt-4">
                                                        ...
                                                        <li style="" class="pull-right">
                                                            <a href="{{ url('admin/single_notice', $notice->notice_id)}} " class="btn  btn-primary ">
