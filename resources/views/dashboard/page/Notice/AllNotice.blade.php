                        ...
                        <div class="content-items w-100">
                            ...
                            <div class="top-author">
                                <div class="author-items" style="border: 1px solid white">
                                        ...
                                        <div class="item">
                                            <div class="info" style="width: 100%; padding-top: 20px">
                                                <h5 class=" text-black "> <a class="notice-title text-black "  href=" {{ route('admin-singleNotice',$notice->notice_id) }}" > {{$notice->notice_name}}</a>
                                                </h5>
                                                <ul class="d-flex align-items-center justify-content-between mt-4">
                                                    ...
                                                    <li style="" class="pull-right">
                                                        <a href="{{ route('admin-singleNotice', $notice->notice_id)}} " class="btn  btn-primary ">
                                                            <i class="fas fa-plus"></i> Read More</a>
                                                    </li>
                                                </ul>
                                            </div>
